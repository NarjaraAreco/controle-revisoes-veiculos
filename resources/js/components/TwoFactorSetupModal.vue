...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            ...
            description:
                'A autenticação em dois fatores foi ativada. Escaneie o QR Code ou informe a chave de configuração no seu aplicativo autenticador.',
            buttonText: 'Fechar',
        };
    }
    ...
    return {
        ...
        description:
            'Para concluir a ativação, escaneie o QR Code ou informe a chave de configuração no seu aplicativo autenticador.',
        buttonText: 'Continuar',
    };
});
